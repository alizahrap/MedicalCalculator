...
class metricbmiCalculatorModel {
...
class bmiMetricViewController: UIViewController {
    ...
    let bmiCalculator = metricbmiCalculatorModel(weight: 0, height: 0)
